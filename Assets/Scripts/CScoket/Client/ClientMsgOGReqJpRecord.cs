...
public class ClientMsgOGReqJpRecord : CmdClientBase {
	...
	private UInt32 client =(UInt32)12345+(UInt32)56;
	#region 构造函数
	
	public ClientMsgOGReqJpRecord(OGReqJpRecord log1)
	...
	protected override void DoSendMsg()
	{
		...
		SendClientMsg.Instance.SendMsg(sendByte, sendByte.Length, client,CmdDefine.GATE_LOGIN_REQ);
