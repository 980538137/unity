...
public class ClientMsgTop : CmdClientBase {
	...
	/// 玩家准备
	/// </summary>
	private OGReqRank Login1;
	private UInt32 clent=(UInt32)12345+(UInt32)9;
	
	#region 构造函数
	
	public ClientMsgTop(OGReqRank log1)
	...
	protected override void DoSendMsg()
	{
		...
		byte[] sendByte = UtilNet.SerializeNetMsg<OGReqRank>(Login1);
		if (null == sendByte)
		{
	...
	{
		OGReqRank recvMsg = UtilNet.DeserializeNetMsg<OGReqRank>(msg);
		if (null == recvMsg)
		{
